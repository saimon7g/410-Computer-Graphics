...
void drawCylinder(double height, double radius, int segments) {
    ...
    cout << "0th X: " << points[0].x << '\n';
    cout << "1st X: " << points[1].x << '\n';
    cout << "0th Y: " << points[0].y << '\n';
    cout << "1st Y: " << points[1].y << '\n';
    glBegin(GL_QUADS);
...
void drawRectangles() {
    ...
    for (int i = 0;i < 4; i++) {
        glPushMatrix(); {
            glRotatef(45 + i * 90, 0, 1, 0);
            glTranslatef(triangleLength / sqrt(2), 0, 0);
            drawCylinder(triangleLength * sqrt(2), sphereRadius, 1);
        }glPopMatrix();
...
void drawSphere() {
    ...
    cout << "Triangle Length: " << triangleLength << '\n';
    cout << "Sphere Radius: " << sphereRadius << '\n';
    Color colors[] = {
        Color::green(),
        Color::green(),
        Color::blue(),
...
void drawCube() {
    double r = triangleLength + sphereRadius * 1 / sqrt(3);
    Color colors[] = {
        Color::green(),
        Color::green(),
        Color::blue(),
    ...
    for (int i = 0; i < 6; i++) {
        glPushMatrix(); {
            glTranslatef(centers[i][0], centers[i][1], centers[i][2]);
            glScalef(sphereRadius * 2 / sqrt(3), sphereRadius * 2 / sqrt(3), sphereRadius * 2 / sqrt(3));
            glRotatef(angles[i], axis[i][0], axis[i][1], axis[i][2]);
            drawSquare(colors[i]);
            //drawCubeSphere(colors[i]);
            //drawSphere();
